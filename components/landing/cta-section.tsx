          ...
          <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-12 sm:py-16 lg:py-20">
            <div className="flex flex-col items-center text-center gap-8">
              <div className="max-w-2xl">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4 text-foreground leading-[1.1]">
                  ¿Listo para reservar tu espacio?
                </h2>

                <p className="text-base sm:text-lg text-secondary mb-8 sm:mb-10 leading-relaxed">
                  Reserva en minutos el espacio perfecto para tu próxima reunión,
                  jornada de coworking, taller o evento.
                </p>

                <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 mb-8 sm:mb-10">

...
export function AnimatedButton({
  ...
  const motionProps = {
    ...
    className: cn(
      'btn-elev-hover inline-flex items-center justify-center gap-2 rounded-md font-medium tracking-[0.05em] transition-colors duration-150 select-none cursor-pointer text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background',
